...
<div id="header"><!-- logo and site title -->
	...
	<div id="scopeTitleSmaller">
		<h1 class="generalTitle">Print Archives Preservation Registry</h1>
		<h2 class="specificTitle">Accessible Tangible Repository<br/>Decision Framework</h2>
	</div>
</div>
